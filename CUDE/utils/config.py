...
from CUDE.utils.logging import s3_url, prepare_dataset_prefix
from CUDE.utils.horovod import on_rank_0
from CUDE.utils.types import is_cfg, is_list
from CUDE.utils.misc import make_list
from CUDE.utils.load import load_class, backwards_state_dict
...
def set_checkpoint(config):
    ...
    if config.checkpoint.filepath is not '':
        ...
        config.checkpoint.filepath = os.path.join(
            ...
            '{task:02d}_{tepoch:02d}_{epoch:d}')
        # Set s3 url
